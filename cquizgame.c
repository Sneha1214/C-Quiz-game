...
int main()
    ...
    system("cls");
     ...
     switch(r1)
		...
		if (toupper(getch())=='C')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.Vatican City");
		           getch();
		       break;
		       }
        ...
        case 4:
		printf("\n\n\nWhich crop is sown on the largest in india??");
		printf("\n\nA.Wheat\t\tB.Rice\n\nC.Sugarcane\t\tD.Maize");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect!!!");count++;
			getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is B.Rice");
		       getch();
		       break;}
...
r=i;
     ...
     switch(r)
		...
		printf("\n\nA.Fort William\t\tB.Fort st David\n\nC.Fort St.george\t\tD.Fort st Angelo");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Fort St.george");getch();
		       goto score;
		       break;}
